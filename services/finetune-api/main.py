...
async def lifespan(app: FastAPI):
    ...
    app.state.sagemaker = SageMakerClient(
        endpoint_name=os.getenv("SAGEMAKER_ENDPOINT_NAME", "finetune-endpoint"),
...
# Metrics
predict_counter = meter.create_counter("finetune_api.predictions")
predict_latency = meter.create_histogram("finetune_api.latency_ms")
